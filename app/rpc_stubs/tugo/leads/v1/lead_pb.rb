...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("tugo/leads/v1/lead.proto", :syntax => :proto3) do
    ...
    add_message "tugo.leads.v1.Lead" do
      ...
      optional :master_ward_id, :message, 10, "google.protobuf.Int64Value"
      optional :master_district_id, :message, 11, "google.protobuf.Int64Value"
      optional :master_province_id, :message, 12, "google.protobuf.Int64Value"
      optional :master_country_id, :message, 13, "google.protobuf.Int64Value"
      optional :description, :message, 14, "google.protobuf.StringValue"
      optional :creator_id, :message, 15, "google.protobuf.Int64Value"
      optional :owner_id, :message, 16, "google.protobuf.Int64Value"
      optional :modified_by_id, :message, 17, "google.protobuf.Int64Value"
      optional :salutation, :message, 18, "google.protobuf.StringValue"
      optional :other_phone, :message, 19, "google.protobuf.StringValue"
      optional :street, :message, 20, "google.protobuf.StringValue"
      optional :delete_flag, :message, 21, "google.protobuf.Int64Value"
      optional :created_at, :message, 22, "google.protobuf.StringValue"
      optional :updated_at, :message, 23, "google.protobuf.StringValue"
    end
  end
end
